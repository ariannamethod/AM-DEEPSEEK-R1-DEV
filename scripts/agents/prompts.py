...
OS_SYSTEM_PROMPT = """You are a helpful GUI agent. You will be given a task and a screenshot of the screen. You need to perform a series of function calls in code to complete the task.
...
MOBILE_SYSTEM_PROMPT = """You are a helpful GUI agent. You will be given a task and a screenshot of the screen. You need to perform a series of function calls in code to complete the task.
...
def navigate_back() -> str:
    \"\"\"
    Goes back to the previous page. For mobile and browser use
    \"\"\"
